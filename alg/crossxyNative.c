...
* 
* # Windows
* gcc -fPIC -c *.c -O3 -static-libgcc -static-libstdc++
* ar -x libgmp.a
 ...
 */
JNIEXPORT jbyteArray JNICALL Java_com_whty_cross_fisco_stub_utils_crypto_CrossxyNative_sm3
 ...
 */
JNIEXPORT jstring JNICALL Java_com_whty_cross_fisco_stub_utils_crypto_CrossxyNative_sm2PrivateKeyToPublicKey
 ...
 */
JNIEXPORT jstring JNICALL Java_com_whty_cross_fisco_stub_utils_crypto_CrossxyNative_sm2Sign
 ...
 */
JNIEXPORT jboolean JNICALL Java_com_whty_cross_fisco_stub_utils_crypto_CrossxyNative_sm2Verify
 ...
 * Signature: ([B)Ljava/lang/String;
 */
JNIEXPORT jbyteArray JNICALL Java_com_whty_cross_fisco_stub_utils_crypto_CrossxyNative_keccak256
  (JNIEnv *env, jclass clazz, jbyteArray j_content) {
    if(NULL == j_content) {
        return NULL;
    }
 ...
 * Signature: ([B)Ljava/lang/String;
 */
JNIEXPORT jbyteArray JNICALL Java_com_whty_cross_fisco_stub_utils_crypto_CrossxyNative_sha256
  (JNIEnv *env, jclass clazz, jbyteArray j_content) {
    if(NULL == j_content) {
        return NULL;
    }
 ...
 */
JNIEXPORT jbyteArray JNICALL Java_com_whty_cross_fisco_stub_utils_crypto_CrossxyNative_hmacSha256
 ...
 * Signature: (Ljava/lang/String;)Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_com_whty_cross_fisco_stub_utils_crypto_CrossxyNative_ecPrivateKeyToPublicKey
  (JNIEnv *env, jclass clazz, jstring j_pri_key_hex) {
    if(NULL == j_pri_key_hex) {
        return NULL;
    }
 ...
 * Signature: (Ljava/lang/String;[B)Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_com_whty_cross_fisco_stub_utils_crypto_CrossxyNative_ecSign
  (JNIEnv *env, jclass clazz, jstring j_pri_key_hex, jbyteArray j_content) {
    if(NULL == j_pri_key_hex || NULL == j_content) {
        return NULL;
    }
 ...
 * Signature: (Ljava/lang/String;[BLjava/lang/String;)Z
 */
JNIEXPORT jboolean JNICALL Java_com_whty_cross_fisco_stub_utils_crypto_CrossxyNative_ecVerify
  (JNIEnv *env, jclass clazz, jstring j_pub_key_hex, jbyteArray j_content, jstring j_sig_hex) {
    if(NULL == j_pub_key_hex || NULL == j_content || NULL == j_sig_hex) {
        return JNI_FALSE;
    }
 ...
 */
JNIEXPORT jstring JNICALL Java_com_whty_cross_fisco_stub_utils_crypto_CrossxyNative_ecRecoverToPublicKey
